package gd.eggs.loading.utils.display
{
	...
	public class LoaderInfo extends EventDispatcher
	{
		...
		protected var parentLoader:gd.eggs.loading.utils.display.Loader;

		protected var commObject:Object;

		public function LoaderInfo(parentLoaderReference:gd.eggs.loading.utils.display.Loader, urlLoaderReference:URLLoader, displayLoaderReference:flash.display.Loader, commObjectReference:Object)
		{
		...
		public function get loader():gd.eggs.loading.utils.display.Loader
		{
			return parentLoader;
		}

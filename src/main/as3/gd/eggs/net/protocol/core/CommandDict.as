package gd.eggs.net.protocol.core
{
	...
	public class CommandDict
	{
		...
		/**
		 * Синглтон, выдает ин�?тан�? �?ловар�? команд
		 * @return
		 */
		...
		/**
		 * Добавить новый итем �? �?оответ�?твующими параметрами
		 * Реги�?трируем в двух �?ловар�?х дл�? бы�?трого до�?тупа по имени либо по иду.
		 * @param    id
		 * @param    name
		 * @param    dataToClient
		 * @param    dataToServer
